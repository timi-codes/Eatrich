  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	  ...
	  <div class="row">
        ...
        <div class="<?php echo $class; ?> product-images col-xs-12 col-md-6">
          <?php if ($thumb || $images) { ?>
...
<?php } ?>
		...
		<div class="<?php echo $class; ?> product-details col-xs-12 col-md-6">
          ...
          <table class="product-info">
            ...
            <?php } ?>
            <tr><td><?php echo $text_model; ?></td><td class="product-info-value"><?php echo $model; ?></td></tr>
            <?php if ($reward) { ?>
		  ...
		  <div class="btn-group">
            <button class="btn btn-default product-btn-wishlist" type="button" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i> <?php echo $button_wishlist; ?></button>
            <button class="btn btn-default product-btn-compare" type="button" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i> <?php echo $button_compare; ?></button>
          </div>
          ...
          <div class="rating">
              ...
              <a class="product-total-review" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $reviews; ?></a> <a class="product-write-review" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><i class="fa fa-pencil"></i>
 <?php echo $text_write; ?></a>
	  ...
	  <div class="related-carousel products-list col-sm-12">
		  <div class="box-heading"><h3><?php echo $text_related; ?></h3></div>
