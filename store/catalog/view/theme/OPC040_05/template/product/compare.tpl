...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> <?php if(count($products) < 1) echo 'print-bg-image no-compare-products'; ?>">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <?php foreach ($products as $product) { ?>
            <td class="text-center table-product-image"><?php if ($product['thumb']) { ?>
        ...
        <tr>
          ...
          <?php foreach ($products as $product) { ?>
			<td>
			<input type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" />
			<button class="btn btn-primary btn-wishlist" type="button" data-toggle="tooltip" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
