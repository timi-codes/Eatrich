        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-tt_blog">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <?php if ($tt_blogs) { ?>
                <?php foreach ($tt_blogs as $blog) { ?>
                <tr>
                  <td class="text-center"><?php if (in_array($blog['tt_blog_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $blog['tt_blog_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $blog['tt_blog_id']; ?>" />
                    <?php } ?></td>
